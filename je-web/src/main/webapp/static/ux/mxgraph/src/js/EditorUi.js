 ...
 */
EditorUi = function(editorEntity)
{
 ...
 */
EditorUi.prototype.init = function(container)
{
	
   	// Resets UI, updates action and menu states
	this.container = container;
	this.editor.graph.init(container);
...
{
	if(this.editor.graph.enableHoverIcons != false){
...
EditorUi.prototype.createKeyHandler = function(editor)
{
	var editorUi = this;
	var graph = this.editor.graph;
	var keyHandler = new mxKeyHandler(graph,editorUi.keyHandlerDom);
	...
	keyHandler.isGraphEvent = function(evt){
		...
		if ((source == this.target || source == editorUi.keyHandlerDom) ||
