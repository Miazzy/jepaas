...
Actions.prototype.doAction = function(key){
	var me = this,editor = me.editorUi.editor,graph = editor.graph;
	var action = me.get(key);
	if (graph.isEnabled() && action && action.isEnabled()){
		action.funct(me.editorUi);
	}
}
/**
...
Actions.prototype.init = function()
{
	...
	this.addAction('left', function() { nudge(37); }, null, 'left', 'LEFT');
	this.addAction('up', function() { nudge(38); }, null, 'up', 'UP');
	this.addAction('right', function() { nudge(39); }, null, 'right', 'RIGHT');
	this.addAction('down', function() { nudge(40); }, null, 'down', 'DOWN');
