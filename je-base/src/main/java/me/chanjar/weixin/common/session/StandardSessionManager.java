...
public class StandardSessionManager implements WxSessionManager, InternalSessionManager {
  ...
  public void processExpires() {
    ...
    if (this.log.isDebugEnabled())
      this.log.debug("Start expire sessions {} at {} sessioncount {}", new Object[]{getName(), timeNow, sessions.length});
    ...
    if (this.log.isDebugEnabled())
      this.log.debug("End expire sessions {} processingTime {} expired sessions: {}", new Object[]{getName(), timeNow, sessions.length});
