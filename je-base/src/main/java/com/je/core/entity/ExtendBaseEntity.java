 ...
 */
@MappedSuperclass
public abstract class ExtendBaseEntity extends BaseEntity {
	@FieldChineseName(value="备用字段1",hidden="1")
	private String ext01;
	@FieldChineseName(value="备用字段2",hidden="1")
	private String ext02;
	@FieldChineseName(value="备用字段3",hidden="1")
	private String ext03;
	@FieldChineseName(value="备用字段4",hidden="1")
	private String ext04;
	@FieldChineseName(value="备用字段5",hidden="1")
