...
/**
 * 利用三个秘钥来加密的DES加密算法,和前台DES.js相对应
 *
 * @author thinkpad
 */
public class Encrypt {
    ...
    public static void main(String[] args) {
        ...
        String fKey = "PCAT1";/* 必需的密钥 */
        String sKey = "PCAT2";
        String tKey = "PCAT3";
        //D34609E450E6406960B36EC9BF6A6DB20087A820E1126F924C0275BA4552B84D
        //D34609E450E6406960B36EC9BF6A6DB20087A820E1126F924C0275BA4552B84D
        String data = "JE_EXPRESS_READ";
    ...
    public static String strEncode(String data, String firstKey, String secondKey, String thirdKey) {
        ...
        return Base64Encrypt.strEncode(data, firstKey, secondKey, thirdKey);
//		int leng = data.length();
//		String encData = "";
//		List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
//		int firstLength = 0, secondLength = 0, thirdLength = 0;
//		if (StringUtil.isNotEmpty(firstKey)) {
...
//		}
//		if (StringUtil.isNotEmpty(thirdKey)) {
...
//				int[] bt = strToBt(data);
//				int[] encByte = null;
//				if (StringUtil.isNotEmpty(firstKey + secondKey + thirdKey)) {
//					int[] tempBt;
//					int x = 0, y = 0, z = 0;
//					tempBt = bt;
...
//					encByte = tempBt;
//				} else {
//					if (StringUtil.isNotEmpty(firstKey + secondKey)) {
//						int[] tempBt;
//						int x = 0, y = 0;
//						tempBt = bt;
//						for (x = 0; x < firstLength; x++) {
...
//		return encData;
    ...
    public static String strDecode(String data, String firstKey, String secondKey, String thirdKey) {
        return Base64Encrypt.strDecode(data, firstKey, secondKey, thirdKey);
//		int leng = data.length();
//		String decStr = "";
//		List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
//		int firstLength = 0, secondLength = 0, thirdLength = 0;
